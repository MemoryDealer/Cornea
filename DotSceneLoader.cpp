...
void DotSceneLoader::processTrigger(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode* pParent)
{
	...
	case TRIGGER_ACTION_CODE::ACTION_AMBIENT_LIGHT_ENABLE:
...
void DotSceneLoader::processNPC(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode* pParent)
{
	NPC::NPC_DATA* data = new NPC::NPC_DATA();

	printf("Processing NPC...\n");

	data->health =				getAttribReal(XMLNode, "health");
	data->activationMethod =	getAttribReal(XMLNode, "activationMethod");
	data->activationRange =		getAttribReal(XMLNode, "activationRange");
	data->speed =				getAttribReal(XMLNode, "speed");
	data->animate =				getAttribBool(XMLNode, "animate");
	data->animationSpeed =		getAttribReal(XMLNode, "animationSpeed");
...
DynamicObjectData* DotSceneLoader::getData(Ogre::SceneNode* node)
{
